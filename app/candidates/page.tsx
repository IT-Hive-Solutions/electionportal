...
import {
  ArrowLeft, Award, MapPin, ChevronRight, X, Users, UserCheck,
  Mail, Phone, BookOpen, Briefcase, Filter, Building2,
} from 'lucide-react';
...
const constituenciesByDistrict: Record<string, { value: string; label: string }[]> = {
...
type Candidate = {
  ...
  assets: string;
  previousElections: { year: string; constituency: string; result: string; votes: number }[];
};

const allCandidates: Candidate[] = [
  {
    id: 'c1', name: 'प्रकाश मान सिंह', party: 'नेपाली काँग्रेस', partyKey: 'congress', partyColor: '#c41e3a',
    constituency: 'काठमाडौं-१', constituencyKey: 'ktm-1', province: 'bagmati', district: 'kathmandu',
    gender: 'male', age: 52, education: 'लोक प्रशासनमा स्नातकोत्तर (TU)',
    ...
    email: 'prakash@example.com', phone: '+977-1-4000001',
    policies: ['शिक्षा सुधार', 'स्वास्थ्य सेवा', 'पूर्वाधार विकास', 'रोजगार सृजना'],
    initials: 'प्र.मा.', criminalRecord: 'कुनै आपराधिक रेकर्ड छैन',
    assets: 'रु. ३,२५,००,०००',
    previousElections: [
      { year: '२०७९', constituency: 'काठमाडौं-१', result: 'विजयी', votes: 22500 },
      { year: '२०७४', constituency: 'काठमाडौं-१', result: 'विजयी', votes: 19800 },
      { year: '२०७०', constituency: 'काठमाडौं-१', result: 'पराजित', votes: 15200 },
    ],
  },
  {
    id: 'c2', name: 'सुशीला कार्की', party: 'नेकपा एमाले', partyKey: 'uml', partyColor: '#003da5',
    constituency: 'काठमाडौं-१', constituencyKey: 'ktm-1', province: 'bagmati', district: 'kathmandu',
    gender: 'female', age: 45, education: 'कानूनमा स्नातकोत्तर (TU)',
    experience: 'मानव अधिकार अधिवक्ता, प्रदेश सभा सदस्य',
    bio: 'महिला अधिकार र सामाजिक न्यायमा केन्द्रित अनुभवी नेतृ।',
    email: 'sushila@example.com', phone: '+977-1-4000002',
    policies: ['महिला सशक्तिकरण', 'सामाजिक न्याय', 'शिक्षामा पहुँच', 'लैङ्गिक समानता'],
    initials: 'सु.का.', criminalRecord: 'कुनै आपराधिक रेकर्ड छैन',
    assets: 'रु. १,८५,००,०००',
    previousElections: [
      { year: '२०७९', constituency: 'काठमाडौं-१', result: 'पराजित', votes: 18200 },
    ],
  },
  {
    id: 'c3', name: 'रमेश लेखक', party: 'नेकपा माओवादी केन्द्र', partyKey: 'maoist', partyColor: '#d4a574',
    constituency: 'काठमाडौं-२', constituencyKey: 'ktm-2', province: 'bagmati', district: 'kathmandu',
    gender: 'male', age: 48, education: 'अर्थशास्त्रमा स्नातकोत्तर',
    experience: 'पूर्व राज्यमन्त्री, सामाजिक कार्यकर्ता',
    bio: 'विकास र आर्थिक सुधारमा केन्द्रित प्रगतिशील नेता।',
    email: 'ramesh@example.com', phone: '+977-1-4000003',
    policies: ['आर्थिक विकास', 'कृषि आधुनिकीकरण', 'युवा रोजगार'],
    initials: 'र.ले.', criminalRecord: 'कुनै आपराधिक रेकर्ड छैन',
    assets: 'रु. २,५०,००,०००',
    previousElections: [
      { year: '२०७९', constituency: 'काठमाडौं-२', result: 'विजयी', votes: 20500 },
      { year: '२०७४', constituency: 'काठमाडौं-२', result: 'पराजित', votes: 14800 },
    ],
  },
  {
    id: 'c4', name: 'गंगा लामा', party: 'नेकपा एमाले', partyKey: 'uml', partyColor: '#003da5',
    constituency: 'ललितपुर-१', constituencyKey: 'ltp-1', province: 'bagmati', district: 'lalitpur',
    gender: 'female', age: 40, education: 'सामाजिक कार्यमा स्नातकोत्तर',
    experience: 'गैसस निर्देशक, सामुदायिक विकास कार्यकर्ता',
    bio: 'स्थानीय विकास र महिला सशक्तिकरणमा समर्पित।',
    email: 'ganga@example.com', phone: '+977-1-4000004',
    policies: ['स्थानीय विकास', 'महिला अधिकार', 'पर्यावरण संरक्षण'],
    initials: 'ग.ला.', criminalRecord: 'कुनै आपराधिक रेकर्ड छैन',
    assets: 'रु. ९५,००,०००',
    previousElections: [],
  },
  {
    id: 'c5', name: 'सुरेश अधिकारी', party: 'नेपाली काँग्रेस', partyKey: 'congress', partyColor: '#c41e3a',
    constituency: 'मोरङ-१', constituencyKey: 'mor-1', province: 'koshi', district: 'morang',
    gender: 'male', age: 55, education: 'राजनीति शास्त्रमा स्नातकोत्तर',
    experience: 'पूर्व गृहमन्त्री, ४ पटक सांसद',
    bio: 'पूर्वाञ्चलको अनुभवी नेता। कृषि र औद्योगिक विकासमा विशेष ध्यान।',
    email: 'suresh@example.com', phone: '+977-1-4000005',
    policies: ['कृषि विकास', 'उद्योग प्रवर्धन', 'पूर्वाधार निर्माण', 'सिँचाइ'],
    initials: 'सु.अ.', criminalRecord: 'कुनै आपराधिक रेकर्ड छैन',
  ...
  {
    id: 'c6', name: 'मीना राई', party: 'स्वतन्त्र', partyKey: 'independent', partyColor: '#2d8659',
    constituency: 'मोरङ-१', constituencyKey: 'mor-1', province: 'koshi', district: 'morang',
    gender: 'female', age: 35, education: 'व्यवसायिक प्रशासनमा MBA',
    experience: 'सामाजिक उद्यमी, युवा नेतृ',
    bio: 'नयाँ पुस्ताको आवाज। भ्रष्टाचार विरुद्ध र सुशासनका लागि स्वतन्त्र उम्मेदवार।',
    email: 'meena@example.com', phone: '+977-1-4000006',
    policies: ['भ्रष्टाचार निवारण', 'सुशासन', 'युवा विकास', 'प्रविधि'],
    initials: 'मी.रा.', criminalRecord: 'कुनै आपराधिक रेकर्ड छैन',
    assets: 'रु. ७५,००,०००',
    previousElections: [],
  },
  {
    id: 'c7', name: 'शंकर पोखरेल', party: 'नेपाली काँग्रेस', partyKey: 'congress', partyColor: '#c41e3a',
    constituency: 'रुपन्देही-१', constituencyKey: 'rup-1', province: 'lumbini', district: 'rupandehi',
    gender: 'male', age: 58, education: 'इन्जिनियरिङमा स्नातक',
    experience: 'पूर्व भौतिक पूर्वाधार मन्त्री',
    bio: 'पूर्वाधार विकासमा विशेषज्ञता भएका अनुभवी नेता।',
    email: 'shankar@example.com', phone: '+977-1-4000007',
    policies: ['सडक निर्माण', 'विद्युत विकास', 'सिँचाइ', 'औद्योगिक विकास'],
    initials: 'शं.पो.', criminalRecord: 'कुनै आपराधिक रेकर्ड छैन',
    assets: 'रु. ४,२०,००,०००',
    previousElections: [
      { year: '२०७९', constituency: 'रुपन्देही-१', result: 'विजयी', votes: 23000 },
      { year: '२०७४', constituency: 'रुपन्देही-१', result: 'पराजित', votes: 16800 },
    ],
  },
  {
    id: 'c8', name: 'राजन गुरुङ', party: 'राष्ट्रिय स्वतन्त्र पार्टी', partyKey: 'raswapa', partyColor: '#6b5b4a',
    constituency: 'कास्की-१', constituencyKey: 'kas-1', province: 'gandaki', district: 'kaski',
    gender: 'male', age: 42, education: 'पर्यटन व्यवस्थापनमा स्नातकोत्तर',
    experience: 'पर्यटन उद्यमी, गण्डकी प्रदेश सभा सदस्य',
    bio: 'पर्यटन र स्थानीय विकासमा केन्द्रित गण्डकीका लोकप्रिय नेता।',
    email: 'rajan@example.com', phone: '+977-1-4000008',
    policies: ['पर्यटन प्रवर्धन', 'स्थानीय रोजगार', 'संस्कृति संरक्षण'],
    initials: 'रा.गु.', criminalRecord: 'कुनै आपराधिक रेकर्ड छैन',
...
export default function Candidates() {
  ...
  const currentConstituencies = constituenciesByDistrict[selectedDistrict] || [{ value: 'all', label: 'सबै निर्वाचन क्षेत्र' }];
  ...
  const filteredCandidates = allCandidates.filter((c) => {
    ...
    if (selectedConstituency !== 'all' && c.constituencyKey !== selectedConstituency) return false;
    if (selectedGender !== 'all' && c.gender !== selectedGender) return false;
    if (selectedParty !== 'all' && c.partyKey !== selectedParty) return false;
    return true;
  });

  const displayedCandidates = showTopOnly ? filteredCandidates.slice(0, 6) : filteredCandidates;
    ...
    return (
      <div className="flex flex-col min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <button onClick={() => setDetailCandidate(null)} className="flex items-center gap-2 text-primary hover:text-primary/80 font-semibold transition-colors text-sm">
            <ArrowLeft size={18} />
        ...
        <section className="bg-card border-b border-border py-8">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-start gap-6">
              <div className="w-20 h-20 rounded-full flex items-center justify-center text-2xl font-bold flex-shrink-0" style={{ backgroundColor: `${c.partyColor}20`, color: c.partyColor }}>
                {c.initials}
              </div>
              <div className="flex-1">
                <h1 className="text-3xl font-bold text-foreground mb-1">{c.name}</h1>
                <div className="flex flex-wrap items-center gap-3 mb-2">
                  <span className="px-3 py-1 rounded-full text-xs font-bold" style={{ backgroundColor: `${c.partyColor}20`, color: c.partyColor }}>{c.party}</span>
                  <span className="flex items-center gap-1 text-sm text-muted-foreground"><MapPin size={14} />{c.constituency}</span>
                  <span className="text-sm text-muted-foreground">उमेर: {c.age}</span>
                  <span className="text-sm text-muted-foreground">{c.gender === 'male' ? 'पुरुष' : c.gender === 'female' ? 'महिला' : 'अन्य'}</span>
                </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
              <div className="bg-card border border-border rounded-xl p-4">
                <div className="flex items-center gap-2 mb-2"><BookOpen size={16} className="text-primary" /><span className="text-xs font-semibold text-muted-foreground">शिक्षा</span></div>
                <p className="text-sm font-semibold text-foreground">{c.education}</p>
              </div>
              <div className="bg-card border border-border rounded-xl p-4">
                <div className="flex items-center gap-2 mb-2"><Briefcase size={16} className="text-primary" /><span className="text-xs font-semibold text-muted-foreground">अनुभव</span></div>
                <p className="text-sm font-semibold text-foreground">{c.experience}</p>
              </div>
              <div className="bg-card border border-border rounded-xl p-4">
                <div className="flex items-center gap-2 mb-2"><Award size={16} className="text-primary" /><span className="text-xs font-semibold text-muted-foreground">सम्पत्ति</span></div>
                <p className="text-sm font-semibold text-foreground">{c.assets}</p>
              </div>
              <div className="bg-card border border-border rounded-xl p-4">
                <div className="flex items-center gap-2 mb-2"><UserCheck size={16} className="text-primary" /><span className="text-xs font-semibold text-muted-foreground">आपराधिक रेकर्ड</span></div>
                <p className="text-sm font-semibold text-foreground">{c.criminalRecord}</p>
              </div>
            </div>

            {/* Policies */}
            <div className="bg-card border border-border rounded-xl p-6 mb-8">
              <h3 className="text-lg font-bold text-foreground mb-4">मुख्य नीतिहरू ({totalPolicyCount})</h3>
              <div className="flex flex-wrap gap-2">
                {c.policies.map((policy, i) => (
                  <span key={i} className="px-4 py-2 rounded-lg text-sm font-medium" style={{ backgroundColor: `${c.partyColor}15`, color: c.partyColor }}>
                    {policy}
                  </span>
                ))}
              </div>
            ...
            {c.previousElections.length > 0 && (
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                <div className="bg-card rounded-xl p-6 border border-border">
                  <h3 className="text-lg font-bold text-foreground mb-5">निर्वाचन इतिहास</h3>
                    ...
                    <BarChart data={c.previousElections} margin={{ left: 10 }}>
                      ...
                      <Bar dataKey="votes" radius={[6, 6, 0, 0]}>
                        {c.previousElections.map((e, i) => (
                          <Cell key={i} fill={e.result === 'विजयी' ? '#2d8659' : '#c41e3a'} />
                        ))}
                      </Bar>
                    </BarChart>
                  </ResponsiveContainer>
                ...
                <div className="bg-card rounded-xl overflow-hidden border border-border">
                  <div className="p-5 bg-primary text-primary-foreground">
                    <h3 className="text-lg font-bold">विस्तृत निर्वाचन इतिहास</h3>
                  </div>
                  <div className="overflow-x-auto">
                    <table className="w-full">
                      <thead>
                        <tr className="border-b border-border bg-muted">
                          <th className="px-4 py-3 text-left font-semibold text-foreground text-sm">वर्ष</th>
                          <th className="px-4 py-3 text-left font-semibold text-foreground text-sm">क्षेत्र</th>
                          <th className="px-4 py-3 text-left font-semibold text-foreground text-sm">नतिजा</th>
                          <th className="px-4 py-3 text-left font-semibold text-foreground text-sm">मत</th>
                        </tr>
                      </thead>
                      <tbody>
                        {c.previousElections.map((election, i) => (
                          <tr key={i} className="border-b border-border hover:bg-muted/50 transition-colors">
                            <td className="px-4 py-3 text-foreground text-sm font-semibold">{election.year}</td>
                            <td className="px-4 py-3 text-foreground text-sm">{election.constituency}</td>
                            <td className="px-4 py-3">
                              <span className={`px-2 py-0.5 rounded-full text-xs font-bold ${election.result === 'विजयी' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}>
                                {election.result}
                              </span>
                            </td>
                            <td className="px-4 py-3 text-foreground text-sm font-semibold">{election.votes.toLocaleString()}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
            ...
            <div className="bg-card border border-border rounded-xl p-6">
              <h3 className="text-lg font-bold text-foreground mb-4">सम्पर्क जानकारी</h3>
              <div className="flex flex-col gap-3">
                <a href={`mailto:${c.email}`} className="flex items-center gap-3 text-sm text-foreground hover:text-primary transition-colors">
                  <Mail size={18} className="text-primary" /> {c.email}
                </a>
                <a href={`tel:${c.phone}`} className="flex items-center gap-3 text-sm text-foreground hover:text-primary transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-background border border-border rounded-xl p-4 text-center">
              ...
              <p className="text-xl font-bold text-foreground">{totalCandidates.toLocaleString()}</p>
            </div>
            <div className="bg-background border border-border rounded-xl p-4 text-center">
            ...
            <div className="bg-card rounded-xl p-6 border border-border">
              ...
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={partyWiseCandidates} layout="vertical" margin={{ left: 20 }}>
                  ...
                  <Tooltip contentStyle={{ backgroundColor: 'var(--card)', border: '1px solid var(--border)', borderRadius: '8px' }} formatter={(value: number) => [value.toLocaleString(), 'उम्मेदवार']} />
                  <Bar dataKey="candidates" radius={[0, 6, 6, 0]}>
                    {partyWiseCandidates.map((p, i) => <Cell key={i} fill={p.color} />)}
                  </Bar>
                </BarChart>
              </ResponsiveContainer>
            </div>
              ...
              <ResponsiveContainer width="100%" height={300}>
                <PieChart>
                  <Pie
                    ...
                    cy="50%"
                    labelLine={false}
                    label={({ name, value }) => `${name} ${Math.round((value / totalCandidates) * 100)}%`}
                    outerRadius={100}
                    dataKey="value"
                    nameKey="name"
                  >
                    {genderDistribution.map((g, i) => <Cell key={i} fill={g.color} />)}
                  </Pie>
              ...
              <ResponsiveContainer width="100%" height={250}>
                <PieChart>
                  <Pie
                    ...
                    nameKey="name"
                  >
                    {educationDistribution.map((e, i) => <Cell key={i} fill={e.color} />)}
                  </Pie>
                  <Tooltip formatter={(value: number) => [value.toLocaleString(), 'उम्मेदवार']} />
                </PieChart>
              </ResponsiveContainer>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-background rounded-xl border border-border p-6 mb-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => { setSelectedProvince(e.target.value); setSelectedDistrict('all'); setSelectedConstituency('all'); }}
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => { setSelectedDistrict(e.target.value); setSelectedConstituency('all'); }}
                  className="w-full px-3 py-2.5 border border-border rounded-lg text-foreground bg-card text-sm focus:ring-2 focus:ring-primary focus:border-transparent transition-all"
                >
                  {currentDistricts.map((d) => <option key={d.value} value={d.value}>{d.label}</option>)}
                </select>
              </div>
              {/* Constituency */}
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2.5 border border-border rounded-lg text-foreground bg-card text-sm focus:ring-2 focus:ring-primary focus:border-transparent transition-all"
                >
                  {currentConstituencies.map((c) => <option key={c.value} value={c.value}>{c.label}</option>)}
                </select>
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="flex items-end">
                <button
                  onClick={() => { setSelectedProvince('all'); setSelectedDistrict('all'); setSelectedConstituency('all'); setSelectedGender('all'); setSelectedParty('all'); }}
          ...
          <div className="flex items-center justify-between mb-6">
            <p className="text-sm text-muted-foreground">
              ...
              {showTopOnly && filteredCandidates.length > 6 && ` (पहिलो ६ देखाइएको)`}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
            {displayedCandidates.map((candidate) => (
              <button
                key={candidate.id}
                onClick={() => { setDetailCandidate(candidate); window.scrollTo(0, 0); }}
              ...
              >
                ...
                <div className="p-5">
                  <div className="flex items-start gap-3 mb-3">
                    <div className="w-12 h-12 rounded-full flex items-center justify-center font-bold text-sm flex-shrink-0" style={{ backgroundColor: `${candidate.partyColor}20`, color: candidate.partyColor }}>
                      {candidate.initials}
                    </div>
                    <div className="flex-1 min-w-0">
                      <h3 className="font-bold text-foreground text-base">{candidate.name}</h3>
                      <p className="text-xs font-semibold" style={{ color: candidate.partyColor }}>{candidate.party}</p>
                  ...
                  <p className="text-muted-foreground text-xs mb-3 line-clamp-2">{candidate.bio}</p>

                  <div className="flex flex-wrap gap-1 mb-3">
                    {candidate.policies.slice(0, 3).map((policy, i) => (
                      <span key={i} className="text-[10px] px-2 py-0.5 rounded-full font-medium" style={{ backgroundColor: `${candidate.partyColor}10`, color: candidate.partyColor }}>
                        {policy}
                      </span>
                    ))}
                  ...
                  <div className="flex items-center justify-between border-t border-border pt-3">
                    <span className="text-xs text-muted-foreground">{candidate.gender === 'male' ? 'पुरुष' : candidate.gender === 'female' ? 'महिला' : 'अन्य'} | उमेर {candidate.age}</span>
          ...
          {filteredCandidates.length > 6 && (
            <div className="text-center">
              ...
              >
                {showTopOnly ? `सबै ${filteredCandidates.length} उम्मेदवार हेर्नुहोस्` : 'कम देखाउनुहोस्'}
              </button>
            </div>
          )}
